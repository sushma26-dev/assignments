    ...
    return(
        <div className="empFull">
            ...
            <form className="empForm was-validated">
                ...
                {/*props.indexObj!==Number ? <button type="submit" className="btn btn-primary" onClick={addEmployee}>Submit</button> : <button type="submit" className="btn btn-primary" onClick={updateEmployee}>Update</button>*/}
